    ...
    return (
        <header >
            <nav className='max-h-50 bg-blue-500 flex' role='navigation'>
                <svg xmlns="http://www.w3.org/2000/svg" className="inline p-2" width="48" height="48" viewBox="0 0 26 26" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
